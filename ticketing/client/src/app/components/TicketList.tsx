      ...
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            A list of all the tickets in your account including their title and price.
          </p>
        </div>
                ...
                {tickets.map((ticket) => (
                  <tr key={ticket.id}>
                    ...
                    <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                      <Link href="/tickets/[ticketId]" as={`/tickets/${ticket.id}`} className="text-indigo-600 hover:text-indigo-900">
